...
uint8_t MPU9250_ADDRESS_1  = 0x69;  // Device address when ADO = 1
uint8_t MPU9250_ADDRESS_2  = 0x68;
uint8_t MPU9250_ADDRESS    = 0x69;
//uint8_t AK8963_ADDRESS     = 0x0C;   //  Address of magnetometer
...
void read_MPU9250_accelgyro(uint8_t MPU9250_address, int16_t * destination)
